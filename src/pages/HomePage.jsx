...
export function HomePage() {
    return (
        <div>
            <section className="flex flex-col px-36 gap-8 mb-10 justify-center w-full h-[462px] relative bg-blue-500 z-0 text-white p-5
            before:content-[''] before:absolute before:bg-[url('/fundacao-bg.jpg')] before:z-[-1] before:inset-0 before:bg-cover before:opacity-20">
                ...
                <nav className="flex gap-8 ">
                    <NavigateButton rota="/localizacao" text="Onde fazer meu exame" variacao="secondary"/>
                    <NavigateButton rota="/vagas" text="Trabalhe Conosco" variacao="white2"/>
                </nav>
            </section>
